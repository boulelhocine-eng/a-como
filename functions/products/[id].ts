...
export const onRequest = async (context: CloudflarePagesContext): Promise<Response> => {
  ...
  // Retrieve base index.html response
  ...
  try {
    ...
    try {
      ...
      response = new Response(originalHtml, { status: 200, headers: { 'content-type': 'text/html; charset=utf-8' } });
    }
  }
  ...
  const ogMetaTags = `
    <!-- Social Preview Open Graph Meta Tags -->
